...
//
void Shop::create_arm(string name = "", string part_number = "", double weight = 0, double cost = 0, int max_power_consumed = 0, string description = "") {
    _arms.push_back(Arm{name, part_number, weight, cost, max_power_consumed, description});
}
vector<Arm> Shop::arms() const {return _arms;}

void Shop::create_battery(string name = "", string part_number = "", double weight = 0,
           double cost = 0, int max_energy_stored = 0, string description = "") {
...
void Shop::create_head(string name = "", string part_number = "", double weight = 0,
           double cost = 0, string description = "") {
    _heads.push_back(Head{name, part_number, weight, 
           cost, description});
}
vector<Head> Shop::heads() const {return _heads;}

void Shop::create_locomotor(string name = "", string part_number = "", double weight = 0,
           double cost = 0, int max_power_consumed = 0, int max_speed_possible = 0, string description = "") {
...
void Shop::create_torso(string name = "", string part_number = 0, double weight = 0,
           double cost = 0, int max_battery_slots = 0, string description = "") {
